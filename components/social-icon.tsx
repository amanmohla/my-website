...
const FacebookIcon = ({ iconSize, iconFill }: IconProps) => (
    <svg fill={iconFill} id="facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" enable-background="new 0 0 24 24">
...
const GithubIcon = ({ iconSize, iconFill }: IconProps) => (
    <svg fill={iconFill} id="github" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
...
const LinkedInIcon = ({ iconSize, iconFill }: IconProps) => (
    <svg fill={iconFill} id="linkedIn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" enable-background="new 0 0 24 24">
...
const TwitterIcon = ({ iconSize, iconFill }: IconProps) => (
    <svg fill={iconFill} id="twitter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" enable-background="new 0 0 24 24">
...
const MailIcon = ({ iconSize, iconFill }: IconProps) => (
    <svg fill={iconFill} id="email" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" enable-background="new 0 0 24 24">
...
const SocialIcon = ({ iconName, ...iconProps }: SocialIconProps) => {
    switch (iconName) {
        case 'facebook': return <FacebookIcon {...iconProps} />; break;
        case 'twitter': return <TwitterIcon {...iconProps} />; break;
        case 'email': return <MailIcon {...iconProps} />; break;
        case 'github': return <GithubIcon {...iconProps} />; break;
        case 'linkedIn': return <LinkedInIcon {...iconProps} />; break;
    }
}
